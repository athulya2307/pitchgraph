...
const PitchGraphMulti = () => {
  ...
  const [useSameFile, setUseSameFile] = useState(null);
  ...
  const onSharedFileChange = (event) => {
    ...
    reader.onload = (e) => {
      ...
      // Set all cards to use this file
      setGraphsData((prev) =>
        prev.map(() => ({
          pitchData: data,
          startTime: '',
            ...
            <div style={styles.selectContainer}>
              ...
              <button
                ...
                onClick={() => {
                  setNumCards(null);
                  setUseSameFile(null);
                  setSharedFileData({ pitchData: [], fileName: '' });
                }}
              >
                Change Number of Cards
              </button>
